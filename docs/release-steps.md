...
[`v10.1.9`](https://github.com/terminusdb/terminusdb/releases/tag/v10.1.9)
<!-- [[[end]]] -->
...
1. Look at the changes to `main` since the last released version: <!--
   ...
   [`10.1.9...main`](https://github.com/terminusdb/terminusdb/compare/v10.1.9...main)
   <!-- [[[end]]] -->
