...
1. Look at the changes to `main` since the last released version: <!--
   ...
   [`11.1.15...main`](https://github.com/terminusdb/terminusdb/compare/v11.1.15...main)
   <!-- [[[end]]] -->
...
4. Create a new tag on `main`:
   ...
   git checkout main
   git pull
   git tag v11.1.16-dev
   git push origin v11.1.16-dev
   ```
   <!-- [[[end]]] -->

5. Create a new GitHub release for the tag: <!--
   [[[cog cog.out(current_repo_version_link) ]]] -->
   [`v11.1.16-dev`](https://github.com/terminusdb/terminusdb/releases/tag/v11.1.16-dev)
   <!-- [[[end]]] -->
