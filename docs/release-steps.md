...
[`v11.0.6`](https://github.com/terminusdb/terminusdb/releases/tag/v11.0.6)
<!-- [[[end]]] -->
...
1. Look at the changes to `main` since the last released version: <!--
   ...
   [`11.0.6...main`](https://github.com/terminusdb/terminusdb/compare/v11.0.6...main)
   <!-- [[[end]]] -->
...
4. Create a new tag on `main`:
   ...
   git pull
   git tag v11.0.7
   git push origin v11.0.7
   ```
   <!-- [[[end]]] -->

5. Create a new GitHub release for the tag: <!--
   [[[cog cog.out(current_repo_version_link) ]]] -->
   [`v11.0.7`](https://github.com/terminusdb/terminusdb/releases/tag/v11.0.7)
   <!-- [[[end]]] -->
