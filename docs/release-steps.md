...
[`v10.1.1`](https://github.com/terminusdb/terminusdb/releases/tag/v10.1.1)
<!-- [[[end]]] -->
...
1. Look at the changes to `main` since the last released version: <!--
   ...
   [`10.1.1...main`](https://github.com/terminusdb/terminusdb/compare/v10.1.1...main)
   <!-- [[[end]]] -->
...
5. Create a new GitHub release for the tag: <!--
   ...
   [`v10.1.2`](https://github.com/terminusdb/terminusdb/releases/tag/v10.1.2)
   <!-- [[[end]]] -->
