TerminusDB adheres to the Berlin Code of Conduct. Available [here](https://berlincodeofconduct.org/) and copied below for ease of reference. Please report any unacceptable behaviour to any maintainer and it will be addressed.
