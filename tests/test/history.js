...
describe('history', function () {
  ...
  describe('history with fresh db', function () {
    ...
    it('pages history', async function () {
      ...
      const result4 = await document.replace(agent, { instance: instance1dot0 })
      ...
      const history1to2 = historyRequest3.body
      expect(history1to2).to.have.lengthOf(2)
      expect(history1to2[0].identifier).to.equal(version3)
      expect(history1to2[1].identifier).to.equal(version2)
    })
